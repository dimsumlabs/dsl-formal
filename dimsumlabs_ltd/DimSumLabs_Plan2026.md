...
**Author:** Japheth (Jay) / DSL Revamp Team
**Status:** Draft
**Date:** 13 June 2026
**Version:** 0.1
...
On 13 June 2026, the core team (Jay, Iulian, Japheth) met and agreed:

- To **revert the AoA to the standard Model Articles** as a clean starting point. This resets the canvas and ensures any future changes are made from a known, neutral baseline.
- To produce this **Design Document** to frame the bigger-picture discussion before re-drafting the AoA.
- That the rapid pace was driven by the lease deadline, not by a desire to exclude anyone. The team shares the same goals — the disagreement was stylistic, not substantive.
...
| # | Goal | Priority |
|---|------|----------|
| G1 | A legally sound Company Limited by Guarantee registered under Cap. 622 | P0 |
| G2 | Constitutional protection against privatisation: objects clause, income lock, dissolution asset lock | P0 |
| G3 | Governance aligned with do-ocracy: those who do, decide (at the operational level) | P1 |
| G4 | Clear separation between statutory governance (AoA) and community operations (By-laws) | P1 |
| G5 | A membership structure where community participants (Club Members) are not exposed to statutory liability | P1 |
...
│  (Statutory, filed with Companies    │
│   Registry. Amended by Special       │
│   Resolution — 75% threshold.)       │
│                                      │
...
The previous AoA draft (February–June 2026), with its unified Member/Director model, do-ocracy objects, non-profit lock-in, and comprehensive removal framework, remains preserved in the git history of this repository. It serves as a reference implementation — a fully worked example of one possible design direction. Any or all of its provisions may be reinstated, modified, or replaced based on the design decisions arising from this document.
